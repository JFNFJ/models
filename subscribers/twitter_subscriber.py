...
from database.models import db, Topic, GeneralResult, EvolutionResult, LocationResult, SourceResult
...
class TwitterSubscriber(BaseSubscriber):
    ...
    def process_message(self, message):
        ...
        if argmax == 0:
            ...
            SourceResult.increment_field(topic.id, tweet_source, "increment_positive")
        elif argmax == 1:
            ...
            SourceResult.increment_field(topic.id, tweet_source, "increment_neutral")
        elif argmax == 2:
            ...
            SourceResult.increment_field(topic.id, tweet_source, "increment_negative")
        else:
